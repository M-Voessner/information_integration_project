...
def disp():
    ...
    try:
        ...
        rating_sign = args.get('rating-sign')
        genre_name = args.get('genre_name')
        date = args.get('date')
        date_sign = args.get('year-sign')
